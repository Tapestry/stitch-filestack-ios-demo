cordova.define("cordova-plugin-filestack.filestack", function(require, exports, module) {
/*
 *
...
var filestack = {
     ...
     */
    setKey:function(key) {
        exec(function() {}, function() {}, 'filestack', 'setKey', [key]);
    },
    /**
     * Set the app name
     * @param name
    ...
    setName:function(name) {
        exec(function() {}, function() {}, 'filestack', 'setName', [name]);
    },
    /**
     * Pick a file
    ...
    pick:function(pickerOptions, successCB, errorCB) {
        ...
        }, errorCB, 'filestack', 'pick', parseArgs(pickerOptions));
    },
    /**
     * Pick multiple files
     * @param pickerOptions options
    ...
    pickMultiple:function(pickerOptions, successCB, errorCB) {
        ...
        exec(successCB, errorCB, 'filestack', 'pick', parseArgs(pickerOptions));
    },
    /**
    ...
    pickAndStore:function(pickerOptions, storeOptions, successCB, errorCB) {
        exec(successCB, errorCB, 'filestack', 'pickAndStore', parseArgs(pickerOptions).concat(parseStoreArgs(storeOptions)));
    }
};

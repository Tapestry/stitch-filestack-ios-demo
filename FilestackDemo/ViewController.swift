...
private let filestackAPIKey = "A2gIk9SirRmCBTCEHXle6z"
...
class ViewController: UIViewController {
    ...
    @IBAction func presentPicker(_ sender: AnyObject) {
        ...
        let client = Filestack.Client(apiKey: filestackAPIKey, security: nil, config: config)
        ...
        //var storeOptions = StorageOptions(location: .s3, access: .public)
        
        let storeOptions = StorageOptions(location: .s3, region: "us-east-1", container: "stitch-app-photos-development", path: "", filename: nil, access: nil)
